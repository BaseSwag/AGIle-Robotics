...
namespace SuperTuple
{
    public class STuple<T1, T2>
    {
        ...
        public static implicit operator ValueTuple<T1, T2>(STuple<T1, T2> t) => (t != null) ? t.tuple : new ValueTuple<T1, T2>();
        public static implicit operator Tuple<T1, T2>(STuple<T1, T2> t) => (t != null) ? t.tuple.ToTuple() : new ValueTuple<T1, T2>().ToTuple();
